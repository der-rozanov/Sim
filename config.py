...
class WindParams:
    ...
    # Вертикальная турбулентность (синусоидальная модель)
    turb_amp:    float = 0.0    # м/с, амплитуда вертикального порыва
    turb_freq:   float = 0.05   # Гц, частота турбулентности (период ~20 с)
